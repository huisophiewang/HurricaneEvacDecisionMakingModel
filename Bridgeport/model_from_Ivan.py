...
def generate_bridgeport_data():
    ...
    for id in all_tract:
        ...
        edu0 = info['Some College'] + info["Bachelor's Degree"] + info['Professional School Degree'] + \
            info["Master's Degree"] + info['Doctorate Degree']
        dist['college_edu'] = [edu0]
        dist['mobile_home'] = [info['Mobile Home']]
        dist['single_fam_home'] = [info['1, Detached']]
...
def model_Ivan():
    # constant, is_male, is_white, have_child, income > 40k, college edu, 
