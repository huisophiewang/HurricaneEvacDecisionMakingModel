...
def prep(input_fp, output_fp):
    ...
    #df['race'].replace({"Caucasian":'white', "African American":'black', "Asian":'asian', "Hispanic":'hispanic', "American Indian":'other', "Other":'other'}, inplace=True)
    df['race'].replace({"Caucasian":1, "African American":2, "Asian":3, "Hispanic":4, "American Indian":0, "Other":0}, inplace=True)
...
if __name__ == '__main__':
    ...
    output_fp = os.path.join('data', 'MTurk_Harvey_var_cluster_v2.csv')
